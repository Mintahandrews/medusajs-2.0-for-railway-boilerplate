    ...
    <>
      <div className="flex flex-col gap-y-6" ref={actionsRef}>
        ...
        <div className="flex gap-4 mt-4">
          <button className="h-14 w-14 flex items-center justify-center border border-gray-300 rounded-lg hover:border-black transition-colors shrink-0">
          ...
          <Button
            ...
            variant="primary"
            className="flex-1 h-14 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors text-base font-medium"
            isLoading={isAdding}
