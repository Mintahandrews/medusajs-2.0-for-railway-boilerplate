...
const MorphingTrigger = () => {
  return (
    <div className="text-letscase-700 hover:bg-grey-5 active:bg-grey-5 active:text-letscase-500 focus:border-letscase-500 disabled:text-grey-30 bg-transparent disabled:bg-transparent rounded-rounded group relative p-[6px]">
