    ...
    <div className="bg-white">
      ...
      {isOpen ? (
        <div data-testid="delivery-options-container">
          ...
          {detectedArea && (
            <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-lg bg-brand-50 border border-brand-100 mb-5">
          ...
          <div className="pb-4">
            {filteredShippingMethods.length > 0 ? (
                    ...
                    return (
                      <RadioGroup.Option
                        ...
                        className={clx(
                          ...
                          {
                            "border-brand bg-brand-50/50 shadow-sm shadow-brand-100":
                              isSelected,
                      ...
                      >
                        ...
                        <div
                          className={clx(
                            ...
                            {
                              "bg-brand-100 text-brand-600": isSelected,
                              "bg-grey-10 text-grey-40": !isSelected,
                            }
                          )}
                        >
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                          ...
                          <div
                            className={clx(
                              ...
                              {
                                "border-brand bg-brand": isSelected,
                                "border-grey-30 bg-white": !isSelected,
                              }
                            )}
                          >
                            {isSelected && (
              ...
              <div className="flex flex-col items-center gap-2 py-8 text-center">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-grey-10">
                  <Package size={20} className="text-grey-40" />
                </div>
        ...
        <div>
          <div className="text-small-regular">
            {cart && hasSelection && (
              <div className="flex items-center gap-3 px-3.5 py-3 rounded-lg bg-grey-5 border border-grey-10">
                <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-brand-100 text-brand-600 shrink-0">
                  <Truck size={16} />
                </div>
