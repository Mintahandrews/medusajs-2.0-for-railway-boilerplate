...
const Payment = ({
  ...
  const useOptions: StripeCardElementOptions = useMemo(() => {
    return {
      ...
      classes: {
        base: "pt-3 pb-1 block w-full h-11 px-4 mt-0 bg-brand-pink-50 border rounded-md appearance-none focus:outline-none focus:ring-0 focus:shadow-borders-interactive-with-active border-ui-border-base hover:bg-brand-pink-100 transition-all duration-300 ease-in-out",
      },
    }
  }, [])
